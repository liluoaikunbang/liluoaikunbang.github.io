...
$('.shift-camera-button').click(function () {
	skyContainer.css({display:"block"})
	...
	$('.intro-container').animate({opacity: 0},function(){
...
/*
2D模型全名称：
男孩：live2d-widget-model-chitose
live2d-widget-model-epsilon2_1
无：live2d-widget-model-gf
live2d-widget-model-haru/01 (use npm install --save live2d-widget-model-haru)
live2d-widget-model-haru/02 (use npm install --save live2d-widget-model-haru)
小孩：live2d-widget-model-haruto
全身女孩：live2d-widget-model-hibiki
黑猫：live2d-widget-model-hijiki
女孩：live2d-widget-model-izumi
可爱小女孩live2d-widget-model-koharu
初音：live2d-widget-model-miku
小男孩：live2d-widget-model-ni-j
小女孩：live2d-widget-model-nico
null：live2d-widget-model-nietzsche
初音小孩：live2d-widget-model-nipsilon
小孩：live2d-widget-model-nito
课桌女孩：live2d-widget-model-shizuku	200	380
猫：live2d-widget-model-tororo
女孩：live2d-widget-model-tsumiki
小孩：live2d-widget-model-unitychan
碗里狗：live2d-widget-model-wanko
女孩：live2d-widget-model-z16
*/
var md = "shizuku";
L2Dwidget.init({
	"model": {
